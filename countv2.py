...
def main(ann_csv, folder, delete, store):
    # imgs = get_imgs(folder)
    num = num_imgs(ann_csv)
    print(num)

if __name__ == '__main__':
    p = argparse.ArgumentParser()
    p.add_argument('ann_csv', help='collated annotation csv file')
    ...
    main(args.ann_csv, args.folder, args.delete, args.store)    